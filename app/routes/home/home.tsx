  ...
  return (
    <>
      ...
      <article>
        ...
        <p>I built this portfolio website in 2016 at the conclusion of a bootcamp to land a position as a web developer. Then, in 2020, I made minor updates to the landing page and linked an updated CV. I didn't take the time to modernise the stack, so the site remained a time capsule of 2016 web development trends: Angular 1, gulp, and bower.</p>
        <p>Now in 2025, we have AI, and I wanted to see if I could update the stack quickly and conveniently the latest tools. The approach was to start from a fresh react router installation and then use AI to sequentially migrate the pages. With some back a forth with claude-4-sonnet in Cursor, I succeeded to migrate the site to React, React Router, and Vite in a day. So now the content is old, but at least the stack is fresh, and the SPA deploys automatically now with GitHub Actions to AWS.</p>
