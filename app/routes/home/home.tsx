  ...
  return (
    <>
      ...
      <article>
        ...
        <p>So the content may be old, but at least the stack is fresh, and because a GitHub Action now automatically deploys the site to AWS, frequent content updates are viable.</p>
